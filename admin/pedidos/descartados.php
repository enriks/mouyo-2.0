...
if(!empty($_POST))
{
    ...
    $sql = "select * from cotizacion where pedido=3 and nombre like ? order by nombre";
    $params = array("%$search%");
            ...
            <div class='col-lg-12'>
                ...
                <ol class='breadcrumb'>
                    ...
                    <li><a href='index.php'>Pedidos</a></li>
                     ...
                     <li class='active'>Descartados</li>
...
{
    $sql = "SELECT cotizacion.id_cotizacion,cotizacion.nombre nombre_cotizacion,usuario.nombre nombre_usuario,cotizacion.fecha,cotizacion.total FROM cotizacion,usuario WHERE cotizacion.id_usuario = usuario.id_usuario and pedido=3 order by cotizacion.nombre";
    $params = null;
    $tabla="<div class='container'>
    <hr>
    <div class='row'>
            <div class='col-lg-12'>
                ...
                <ol class='breadcrumb'>
                    ...
                    <li class='active'>Descartados</li>
                    <li><a href='index.php'>Pedidos</a></li>
                    <li><a href='index.php'>Procesados</a></li>
                </ol>
            </div>
        </div>
        <div class='row'>
