...
$pdf->Cell(190, 8, 'LISTADO DE DESCUENTOS',1,0,'C',1);
$pdf->Ln(8);
$pdf->SetFillColor(255,255,204);
$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(15, 8,' ID',1,0,'L',1);
$pdf->Cell(75, 8, ' Nombre',1,0,'L',1);
$pdf->Cell(50, 8, ' Fecha Inicio',1,0,'L',1);
$pdf->Cell(50, 8, utf8_decode(' Fecha Límite'),1,0,'L',1);
$pdf->Ln(8);
foreach($data as $row)
    {
    $pdf->SetFont('Arial','',10);
    $pdf->Cell(15,8,$row['id_descuento'],0);
    $pdf->Cell(75,8,$row['nombre'],0);
    $pdf->Cell(50,8,$row['fecha_inicio'],0);
    $pdf->Cell(50,8,$row['fecha_limite'],0);
